...
import { Zap, ShoppingCart, Gift, TrendingUp, Heart, Clock, AlertCircle, Package } from 'lucide-react';
...
const ProactiveTemplates = ({ onSelectTemplate }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Select pre-built templates to quickly set up engagement triggers</p>
        </div>
      </div>
          ...
          >
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="space-y-2 text-xs text-gray-600">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-gray-900">
                    {template.trigger.trigger_type.replace(/_/g, ' ')}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Delay:</span>
              ...
              <button
                ...
                className="w-full py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-200 font-medium text-sm shadow-sm hover:shadow-md"
              >
                Use This Template
              </button>
            </div>
