...
const rolePermissions = {
  ...
  [ROLES.AGENT]: [
    // Can handle conversations and basic features
    PERMISSIONS.VIEW_BOT_CONFIG,
...
export const FEATURE_ACCESS = {
  ...
  botbuilder: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  conversations: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER, ROLES.AGENT, ROLES.USER],
  scenarios: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  forms: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  proactive: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  crm: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  ecommerce: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  multichannel: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  sms: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  phone: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  faq: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
  widget: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER, ROLES.AGENT, ROLES.USER],
  webhooks: [ROLES.ADMIN, ROLES.DEVELOPER], // ADMIN/DEV ONLY
  analytics: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER, ROLES.AGENT],
  integrations: [ROLES.ADMIN, ROLES.DEVELOPER], // ADMIN/DEV ONLY
  security: [ROLES.ADMIN, ROLES.DEVELOPER], // ADMIN/DEV ONLY
  users: [ROLES.ADMIN], // ADMIN ONLY
  billing: [ROLES.ADMIN, ROLES.DEVELOPER, ROLES.MANAGER],
